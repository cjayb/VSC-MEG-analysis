...
if do_make_FFA_functional_label_individual_from_groupavg:
    ...
    # This doesn't seem to work? May be due to label morphing to src issues
    # Check inuse-use from above and test!
    pass
    ...
    #                       n_jobs=4, copy=False)
    #
    #         # use label as-is, even though it won't look good on highres surf
    #         labels[hemi]['gavg'] = cur_lab
    #         mne.write_label(out_label_name_schema.format(hemi, func_cont),
    #                         labels[hemi]['gavg'])
    #
    #     import matplotlib.pylab as pylab
